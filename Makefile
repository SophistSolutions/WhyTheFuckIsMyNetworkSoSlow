...
ifeq ($(DETECTED_HOST_OS), Darwin)
	...
	@(export MAKE_INDENT_LEVEL=$$(($(MAKE_INDENT_LEVEL)+1)) && cd $(StroikaRoot) && ./configure Release-Logging --config-tag Unix --only-if-has-compiler --compiler-driver 'g++' $(STROIKA_CONFIG_PARAMS_COMMON) --trace2file enable $(STROIKA_CONFIG_PARAMS_RELEASE));
	...
	@(export MAKE_INDENT_LEVEL=$$(($(MAKE_INDENT_LEVEL)+1)) && cd $(StroikaRoot) && ./configure Release-Logging --config-tag Unix --only-if-has-compiler --compiler-driver 'g++-12' $(STROIKA_CONFIG_PARAMS_COMMON) --trace2file enable $(STROIKA_CONFIG_PARAMS_RELEASE));
	...
	@(export MAKE_INDENT_LEVEL=$$(($(MAKE_INDENT_LEVEL)+1)) && cd $(StroikaRoot) && ./configure Release-Logging --config-tag Unix --only-if-has-compiler --compiler-driver 'g++-13' $(STROIKA_CONFIG_PARAMS_COMMON) --trace2file enable $(STROIKA_CONFIG_PARAMS_RELEASE));
	...
	@(export MAKE_INDENT_LEVEL=$$(($(MAKE_INDENT_LEVEL)+1)) && cd $(StroikaRoot) && ./configure Release-Logging --config-tag Unix --only-if-has-compiler --compiler-driver 'g++-14' $(STROIKA_CONFIG_PARAMS_COMMON) --trace2file enable $(STROIKA_CONFIG_PARAMS_RELEASE));

...
// @todo consider optionally loading API_ROOT from localStorage as override - just for debugging
export const API_ROOT: string = 
    process.env.VUE_APP_ROOT_API ??
    (window.location.protocol + "//" + window.location.hostname + ":" + (process.env.VUE_APP_DEFAULT_API_PORT ?? "8080"))
    ;

...
namespace {
    URI TransformURL2LocalStorage_ (const URI& url)
    {
        ...
        try {
            ...
            Logger::sThe.LogIfNew (Logger::Priority::eError, 1min, L"Database update: ignoring exception in TransformURL2LocalStorage_: %s", Characters::ToString (e).c_str ());
            ...
            Logger::sThe.LogIfNew (Logger::Priority::eError, 1min, L"Database update: ignoring exception in TransformURL2LocalStorage_: %s", Characters::ToString (current_exception ()).c_str ());
            AssertNotReached ();
        }

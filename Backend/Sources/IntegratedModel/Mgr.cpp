...
namespace {
    URI TransformURL2LocalStorage_ (const URI& url)
    {
        ...
        try {
            ...
            Logger::sThe.Log (Logger::Priority::eError, L"Database update: ignoring exception in TransformURL2LocalStorage_: %s", Characters::ToString (e).c_str ());
            ...
            Logger::sThe.Log (Logger::Priority::eError, L"Database update: ignoring exception in TransformURL2LocalStorage_: %s", Characters::ToString (current_exception ()).c_str ());
            AssertNotReached ();
        }
        ...
        void BackgroundDatabaseThread_ ()
        {
            ...
            while (true) {
                try {
                    ...
                    Logger::sThe.Log (Logger::Priority::eWarning, L"Database update: ignoring exception in BackgroundDatabaseThread_ loop (will retry in 30 seconds): %s", Characters::ToString (current_exception ()).c_str ());
                    Execution::Sleep (30s);
                }
            }
        }

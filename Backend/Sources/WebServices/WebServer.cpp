...
const WebServiceMethodDescription WebServer::Rep_::kNetworks_{
    ...
    Sequence<String>{L"curl http://localhost/api/v1/networks"sv,
                     ...
                     L"curl -v -X PATCH --output - -H \"Content-Type: application/json\" -d '[{\"op\":\"add\",\"path\":\"/userOverrides/aggregateFingerprint\",\"value\":[\"449b7f39-0cba-6cf6-dc7d-1b1998566098\",\"27ea14ab-04c8-e8f5-ddff-a3bd24503497\"]}]' http://localhost/api/v1/networks/4b0103ed-5dfc-8639-0fb4-7dbcd62fb9fb",
                     L"curl -v -X PATCH --output - -H \"Content-Type: application/json\" -d '[{\"op\":\"remove\",\"path\":\"/userOverrides/aggregateFingerprint\"}]' http://localhost/api/v1/networks/1e0dba3d-55f9-cdee-5d81-0a83aae5ab43",

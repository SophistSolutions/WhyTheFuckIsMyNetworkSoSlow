...
const WebServiceMethodDescription WebServer::Rep_::kNetworks_{
    ...
    Sequence<String>{L"curl http://localhost/api/v1/networks"sv,
                     ...
                     L"curl -v -X PATCH --output - -H \"Content-Type: application/json\" -d '[{\"op\":\"add\",\"path\":\"/userOverrides/aggregateHardwareAddresses\",\"value\":[\"70:97:41:94:1a:00\"]}]' http://localhost/api/v1/networks/d4a16729-ba16-5c2f-6187-0925a2f7025d",
                     L"curl -v -X PATCH --output - -H \"Content-Type: application/json\" -d '[{\"op\":\"remove\",\"path\":\"/userOverrides/aggregateHardwareAddresses\"}]' http://localhost/api/v1/networks/d4a16729-ba16-5c2f-6187-0925a2f7025d"},
